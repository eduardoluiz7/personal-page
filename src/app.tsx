      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
          ...
          <div className='flex items-center gap-2 flex-1'>
            ...
            <input className='bg-transparent text-lg placholder-zinc-400 outline-none' type="text" placeholder="Para onde você vai?" />
          </div>
          
          <div className='flex items-center gap-2'>
            <Calendar className="size-5 text-zinc-400" />
            <input className='bg-transparent text-lg placholder-zinc-400 w-40 outline-none' type="text" placeholder="Quando?" />
          </div>
