...
export function App() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState(["eduardoluiz@email.com"])
      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className='space-y-4'>
          ...
          <div className='flex items-center gap-2 flex-1'>
            ...
            <input disabled={isGuestInputOpen} className='bg-transparent text-lg placholder-zinc-400 outline-none flex-1' type="text" placeholder="Para onde você vai?" />
          </div>

          <div className='flex items-center gap-2'>
            <Calendar className="size-5 text-zinc-400" />
            <input disabled={isGuestInputOpen} className='bg-transparent text-lg placholder-zinc-400 w-40 outline-none' type="text" placeholder="Quando?" />
          </div>
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <form onSubmit={addNewEmailToInvite} className="p-2.5 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2">
              <div className="px-2 flex items-center flex-1 gap-2">
                ...
                <input 
                  name="email"
                  className='bg-transparent text-lg placholder-zinc-400 outline-none flex-1'
                  type="email"
